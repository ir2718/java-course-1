...
public interface CalcModel {
	...
	/**
	 * Postavlja zamrznutu vrijednost.
	 * 
	 * @param freezeValue zadana vrijednost koju treba postaviti
	 */
	void setFreezeValue(String freezeValue);
	
	/**
	 * Provjerava vrijednost parametra zamrznute vrijednosti.
	 *
