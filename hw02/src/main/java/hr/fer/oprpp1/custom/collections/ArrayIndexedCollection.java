 ...
 *
 */
public class ArrayIndexedCollection implements List, Collection {
...
//		System.out.println(Arrays.toString(c.toArray()));
//		ElementsGetter get = new ArrayElementsGetter(c);
//		get.getNextElement();
//		c.remove(1);
//		System.out.println(Arrays.toString(c.toArray()));
...
//	}
	...
	private static class ArrayElementsGetter implements ElementsGetter {
		...
		private ArrayIndexedCollection ref;
		 ...
		 */
		public ArrayElementsGetter(ArrayIndexedCollection ref) {
			currentIndex = 0;
