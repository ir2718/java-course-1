 ...
 *
 */
public class LinkedListIndexedCollection<T> implements List<T>, Collection<T> {
	...
	public void insert(T value, int position) {
		...
		int i = size-1;
		ListNode<T> helper = last.previous;
	...
	public void remove(int index) {
		...
		ListNode<T> node2 = node.previous;
	...
	private static class LinkedListElementsGetter<T> implements ElementsGetter<T> {
		...
		private LinkedListIndexedCollection<? extends T> listRef;
		private ListNode<? extends T> ref;
		 ...
		 */
		public LinkedListElementsGetter(LinkedListIndexedCollection<? extends T> listRef) {
			currentIndex = 0;
